...
function Promptpoem() {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const response = await fetch('http://localhost:8000/poem/generate/', {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        history('/poemprompt',{state:{sid,title, poem, imageSrc}});
